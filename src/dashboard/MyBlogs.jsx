...
function MyBlogs() {
    ...
    const fetchMyBlogs = async () => {
      try {
        const { data } = await axios.get(
          "https://campusbuzz-server.onrender.com/api/blogs/my-blog",
  ...
  const handleDelete = async (id) => {
    await axios
      .delete(`https://campusbuzz-server.onrender.com/api/blogs/delete/${id}`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  return (
    <div className="ml-64 container mx-auto my-12 p-4">
